...
if __name__ == "__main__":
    ...
    np.save("../results/nav_dpgpd_k.npy", Ks)
    np.save("../results/nav_dpgpd_l.npy", lambdas)
    np.save("../results/nav_dpgpd_ploss.npy", losses_primals)
    np.save("../results/nav_dpgpd_dloss.npy", losses_duals)"""

    losses_primals, losses_duals = zip(*results_pgdual)
    avg_losses_primal = np.mean(losses_primals, axis=0)
    avg_losses_dual = np.mean(losses_duals, axis=0)

    np.save("../results/nav_pgdual_ploss.npy", losses_primals)
    np.save("../results/nav_pgdual_dloss.npy", losses_duals)
